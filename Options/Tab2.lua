...
ns.LazyBuild(ns.tabframe2, function()
--分页2滚动框架
...
ns.AddSetDropdTexture2(ConFrame2,2,L["箭头材质"],L["箭头材质"],"arrowTexture",ns.ArrowTexture,ns.UpdateHpTexture)
ns.AddSetColorF(ConFrame2,2,L["箭头颜色"],L["箭头颜色"],"arrowColor",ns.UpdateTargetTexture)
ns.AddSetSlider(ConFrame2,2,L["箭头尺寸"],L["箭头尺寸"],5,50,1,"%d","arrowScale",ns.UpdateHpTexture)
